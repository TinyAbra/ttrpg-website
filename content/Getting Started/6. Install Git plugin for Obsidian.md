In order to commit changes from directly inside of Obsidian, rather than using a CLI or terminal instance - we recommend installing the Git plugin for Obsidian. 
